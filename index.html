...
<body>
    ...
    <!--Début Header-->
        ...
        <div class="navbar">
            <ul class="nav">
                ...
                <li><a class="nav_item" href="contact.html"><img class="nav_item--img" src="maquette/Asset/logo/icons8-contact-d'affaires-50.png" alt="contact"></a></li>
    ...
    <div class="hero_image">
         ...
         <div class="hero_text">
            ...
            <h2 class="hero_text_title">Je suis <strong class="hero_text_title--name">OMAYMA HAJJAMI,</strong><br>une développeuse web Full Stack</h2>
            <a class="hero_text_button" href="contact.html">Contactez moi</a> 
